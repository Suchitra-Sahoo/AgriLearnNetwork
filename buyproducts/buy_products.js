...
//     // box.innerHTML="no search found";
// }
// }
//   }

// Get the search input element by its ID 'searchbar'
const searchinput = document.getElementById('searchbar');
searchinput.addEventListener('input', searchProducts);

function searchProducts() {
    // Select all elements with the class 'product' and convert the NodeList to an array
    let box = [...document.querySelectorAll(".product")];

    // Get the input element by its ID 'searchbar'
    let val = document.getElementById('searchbar');
    ...
    // Log the array of elements with class 'product' for debugging purposes
    console.log(box);
    ...
    for (let i = 0; i < box.length; i++) {
        ...
        // Select the <h3> element within the current component
        let h3 = component.querySelector('h3');
